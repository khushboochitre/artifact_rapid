...
bool AggressiveDeadCodeElimination::isAlwaysLive(Instruction &I) {
  if (isa<CallInst>(I) && cast<CallInst>(I).getIntrinsicID() == Intrinsic::custom_noalias) {
    return true;
  }
  if (isa<CallInst>(I) && cast<CallInst>(I).getIntrinsicID() == Intrinsic::dynamic_noalias_check) {
    return true;
  }

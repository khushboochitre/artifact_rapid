...
void initializeAdditionalVectorizationPass(PassRegistry&);
void initializeRegionBasedDisPass(PassRegistry&);
...
void initializeAllocator2kLegacyPassPass(PassRegistry&);

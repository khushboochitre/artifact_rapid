...
class AAResults {
  bool disableCustomIntrinsicChecks = false;
public:
  void setDisableCustomIntrinsicChecks(bool val) {
    disableCustomIntrinsicChecks = val;
  }
  bool getDisableCustomIntrinsicChecks() {
    return disableCustomIntrinsicChecks;
  }

...
// -------------------------------------------------------------------------------------
#define MI_ALIGNMENT_MAX   (16*1024*1024UL)    // maximum supported alignment is 1MiB
...
mi_decl_nodiscard mi_decl_export mi_decl_restrict void* mi_region_malloc(size_t size, int region) mi_attr_noexcept mi_attr_malloc mi_attr_alloc_size(2);
mi_decl_nodiscard mi_decl_export mi_decl_restrict void* mi_heap_zalloc(mi_heap_t* heap, size_t size) mi_attr_noexcept mi_attr_malloc mi_attr_alloc_size(2);
mi_decl_nodiscard mi_decl_export mi_decl_restrict void* mi_heap_calloc(mi_heap_t* heap, size_t count, size_t size) mi_attr_noexcept mi_attr_malloc mi_attr_alloc_size2(2, 3);
mi_decl_nodiscard mi_decl_export mi_decl_restrict void* mi_region_calloc(size_t count, size_t size, int region) mi_attr_noexcept mi_attr_malloc mi_attr_alloc_size2(2, 3);
mi_decl_nodiscard mi_decl_export mi_decl_restrict void* mi_heap_mallocn(mi_heap_t* heap, size_t count, size_t size) mi_attr_noexcept mi_attr_malloc mi_attr_alloc_size2(2, 3);
mi_decl_nodiscard mi_decl_export mi_decl_restrict void* mi_heap_malloc_small(mi_heap_t* heap, size_t size) mi_attr_noexcept mi_attr_malloc mi_attr_alloc_size(2);

mi_decl_nodiscard mi_decl_export void* mi_heap_realloc(mi_heap_t* heap, void* p, size_t newsize)              mi_attr_noexcept mi_attr_alloc_size(3);
mi_decl_nodiscard mi_decl_export void* mi_region_realloc(void* p, size_t newsize, int region)              mi_attr_noexcept mi_attr_alloc_size(3);
...
mi_decl_nodiscard mi_decl_export mi_decl_restrict void* mi_region_aligned_alloc(size_t alignment, size_t size, int region_id) mi_attr_noexcept mi_attr_malloc mi_attr_alloc_size(2) mi_attr_alloc_align(3);
...
mi_decl_export int mi_region_posix_memalign(void** p, size_t alignment, size_t size, int region_id)   mi_attr_noexcept;

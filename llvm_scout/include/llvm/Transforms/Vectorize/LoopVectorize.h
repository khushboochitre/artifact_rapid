...
struct LoopVectorizePass : public PassInfoMixin<LoopVectorizePass> {
  ...
  bool processLoop(Loop *L, Loop **NewLoop, BasicBlock **RuntimeChecksBlock, bool allowCloning);

  bool isVectorizationPossible(Loop *L, PredicatedScalarEvolution &PSE, DominatorTree *DT,
